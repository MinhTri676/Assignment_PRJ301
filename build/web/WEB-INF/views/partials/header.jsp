...
<header class="site-header bg-white border-bottom py-2" role="banner">
    <div class="container d-flex align-items-center justify-content-between header-inner">
        ...
        <nav class="nav me-3">
            ...
            <a class="nav-link px-2 text-secondary" href="${pageContext.request.contextPath}/products">Về chúng tôi</a>
                    ...
                    <div class="dropdown user-dropdown me-2">
                        ...
                        <a id="userDropdown" class="btn btn-outline-secondary btn-sm d-flex align-items-center dropdown-toggle" href="#"
                           data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-md-inline">Xin chào, <c:out value="${sessionScope.customer.customerName}" /></span>
                        </a>
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <!-- Logout as POST to /auth with action=logout; adjust endpoint if your AuthController uses something else -->
