                ...
                <section class="content container">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="categoryCreateForm" method="post" action="${pageContext.request.contextPath}/MainController">
                                <div class="form-row">
                                    <div class="form-col">
                                ...
                                <div class="form-row">
                                    <div class="form-col">
                                        <label class="input-label" for="productImageFile">Ảnh thương hiệu</label>
