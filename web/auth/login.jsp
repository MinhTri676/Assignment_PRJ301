...
<body>
    <div class="auth-container">
        <div class="auth-wrapper">
            <!-- Back to home button -->
            <a href="index.jsp" class="back-home" style="position: absolute; top: 20px; left: 20px; color: white; text-decoration: none; z-index: 10; font-weight: 500;">
                ...
                <div class="auth-form">
                    ...
                    <form action="login" method="post" class="login-form">
                        ...
                        <div class="form-footer">
                            Chưa có tài khoản? <button type="button" class="switch-form-btn">Đăng ký ngay</button>
                        </div>
                    </form>
                ...
                <div class="auth-form">
                    ...
                    <form action="addAccount" method="post" class="register-form">
                        ...
                        <div class="checkbox-group">
                            ...
                            <label for="terms">Tôi đồng ý với <a href="#" style="color: var(--primary-color);">Điều khoản sử dụng</a></label>
                        </div>

                        <button type="submit" class="submit-btn">Đăng ký</button>

                        <div class="form-footer">
                            Đã có tài khoản? <button type="button" class="switch-form-btn">Đăng nhập</button>
                        </div>
                    </form>
