...
<html lang="vi">
    <head>
        ...
        <title>Thêm sản phẩm — Shoptech Admin</title>
            ...
            <main class="main">
                ...
                <section class="content container">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="createForm" method="POST" action="${pageContext.request.contextPath}/MainController">
                                ...
                                <div class="form-row">
                                    <div style="max-width:160px;">
                                        ...
                                        <input id="quantity" name="txtQuantity" type="number" min="0" value="0" required class="form-input"/>
                                    </div>

                                    <div style="max-width:220px;">
                                        <label class="input-label" for="price">Giá (VNĐ)</label>
                                        <input id="price" name="txtPrice" type="number" min="0" step="1000" value="0" required class="form-input"/>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div style="max-width:160px; text-align:center;">
                                            ...
                                            <img id="previewCreate" class="thumb-preview"/>
                                        </div>
                                    </div>
